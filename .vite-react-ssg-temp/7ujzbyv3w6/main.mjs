...
function Home() {
  ...
  const founders = [
    { id: 1, t: "30%", r: "22%", mt: "35%", mr: "15%", size: "md:w-48 md:h-48 w-28 h-28", delay: "0s" },
    // HUB
  ...
  return /* @__PURE__ */ jsxs("div", { className: "pt-[60px] md:pt-[72px] font-['Inter',sans-serif] bg-white overflow-hidden", children: [
    /* @__PURE__ */ jsx("style", { children: `
          @keyframes marquee {
        ...
        ` }),
    /* @__PURE__ */ jsxs("section", { className: "bg-[#0B3B4A] relative min-h-[100vh] md:min-h-[850px] flex items-center overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-0 pointer-events-none", children: [
        /* @__PURE__ */ jsxs("svg", { className: "absolute inset-0 w-full h-full hidden md:block opacity-40", xmlns: "http://www.w3.org/2000/svg", children: [
          /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "lineGrad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
            /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: "#C4912A", stopOpacity: "0" }),
            /* @__PURE__ */ jsx("stop", { offset: "50%", stopColor: "#C4912A", stopOpacity: "0.8" }),
            /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: "#C4912A", stopOpacity: "0" })
          ] }) }),
          /* @__PURE__ */ jsxs("g", { stroke: "url(#lineGrad)", strokeWidth: "1", fill: "none", className: "network-line", children: [
            /* @__PURE__ */ jsx("line", { x1: "78%", y1: "30%", x2: "90%", y2: "5%" }),
            /* @__PURE__ */ jsx("line", { x1: "78%", y1: "30%", x2: "65%", y2: "8%" }),
            /* @__PURE__ */ jsx("line", { x1: "78%", y1: "30%", x2: "58%", y2: "25%" }),
            /* @__PURE__ */ jsx("line", { x1: "78%", y1: "30%", x2: "62%", y2: "52%" }),
            /* @__PURE__ */ jsx("line", { x1: "78%", y1: "30%", x2: "90%", y2: "55%" }),
            /* @__PURE__ */ jsx("path", { d: "M 90% 5% L 65% 8% L 58% 25% L 62% 52% L 90% 55% Z", strokeWidth: "0.5", strokeOpacity: "0.15" })
          ] })
        ] }),
        founders.map((f) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute inset-[-12px] rounded-full bg-[#C4912A]/20 blur-2xl animate-pulse" }),
              /* @__PURE__ */ jsxs("div", { className: `${f.size} rounded-full border-[1.5px] md:border-[2.5px] border-[#C4912A]/50 overflow-hidden relative shadow-[0_0_50px_rgba(196,145,42,0.3)]`, children: [
                /* @__PURE__ */ jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[#C4912A]/5 mix-blend-overlay" })
              ] })
            ] })
          },
          f.id
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-[1440px] mx-auto pt-24 md:pt-[72px] px-6 md:px-12 pb-16 relative z-10 w-full", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[9px] md:text-[10.5px] tracking-[.24em] uppercase text-white/50 font-semibold mb-6 flex items-center gap-3 before:content-[''] before:block before:w-5 md:before:w-7 before:h-px before:bg-white/30", children: "Advocates & Legal Advisors  ·  Bengaluru" }),
        /* @__PURE__ */ jsxs("h1", { className: "font-['Cormorant_Garamond',serif] text-[clamp(40px,7.5vw,84px)] text-white leading-[1.1] md:leading-[1.02] font-normal tracking-[-.01em] mb-6 max-w-[850px]", children: [
          "Legal strategy for founders",
          /* @__PURE__ */ jsx("br", { className: "hidden sm:block" }),
          "who want to ",
          /* @__PURE__ */ jsx("em", { className: "text-[#C4912A] italic", children: "move fast." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[14px] md:text-[15px] text-white/65 leading-[1.7] md:leading-[1.8] max-w-[520px] mb-9 font-light", children: "12+ years of in-house and private practice experience · now available to the founders and businesses that need it most." }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-5 mb-16", children: [
          /* @__PURE__ */ jsx(Link, { to: "/services", className: "w-full sm:w-auto text-center bg-[#C4912A] hover:bg-[#a87822] text-white py-[13px] px-[30px] text-[11px] md:text-[11.5px] font-semibold tracking-[.1em] uppercase transition-colors", children: "Our Practice Areas" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-row border-t border-white/10 w-full overflow-x-auto no-scrollbar pt-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "py-5 pr-8 md:pr-12 mr-8 md:mr-12 border-r border-white/10 flex gap-3.5 items-baseline whitespace-nowrap", children: [
            /* @__PURE__ */ jsx("div", { className: "font-['Cormorant_Garamond',serif] text-[28px] md:text-[36px] text-white leading-none", children: "12+" }),
            /* @__PURE__ */ jsx("div", { className: "text-[10px] md:text-[11.5px] text-white/50 leading-[1.4] font-sans", children: "Years in-house · private practice" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "py-5 pr-8 md:pr-12 mr-8 md:mr-12 border-r border-white/10 flex gap-3.5 items-baseline whitespace-nowrap", children: [
            /* @__PURE__ */ jsx("div", { className: "font-['Cormorant_Garamond',serif] text-[28px] md:text-[36px] text-white leading-none", children: "5" }),
            /* @__PURE__ */ jsx("div", { className: "text-[10px] md:text-[11.5px] text-white/50 leading-[1.4] font-sans", children: "Core practice areas" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "py-5 flex gap-3.5 items-baseline whitespace-nowrap", children: [
            /* @__PURE__ */ jsx("div", { className: "font-['Cormorant_Garamond',serif] text-[28px] md:text-[36px] text-white leading-none", children: "Est. 2024" }),
            /* @__PURE__ */ jsx("div", { className: "text-[10px] md:text-[11.5px] text-white/50 leading-[1.4] font-sans", children: "Bengaluru · Serving India" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "bg-[#0B3B4A] py-3 md:py-[18px] border-t border-white/5 relative overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "animate-marquee", children: [...marqueeItems, ...marqueeItems].map((item, i) => /* @__PURE__ */ jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsx("span", { className: "text-[10px] md:text-[11.5px] tracking-[.12em] uppercase text-white/55 font-medium whitespace-nowrap mx-4 md:mx-6", dangerouslySetInnerHTML: { __html: item } }),
      /* @__PURE__ */ jsx("span", { className: "text-[#C4912A] text-[16px] md:text-[18px]", children: "·" })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxs("div", { className: "bg-[#FAF8F4]", children: [
      /* @__PURE__ */ jsxs("div", { className: "py-12 md:pt-[52px] md:pb-9 px-6 md:px-[52px] grid grid-cols-1 md:grid-cols-[200px_1fr] gap-4 md:gap-10 items-baseline border-b border-[#0B3B4A]/10", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[10px] md:text-[11px] tracking-[.22em] uppercase text-[#C4912A] font-semibold", children: "Why FCC" }),
        /* @__PURE__ */ jsxs("h2", { className: "font-['Cormorant_Garamond',serif] text-[clamp(26px,4vw,40px)] text-[#0B3B4A] font-normal leading-[1.2]", children: [
      ...
      ].map((w, i) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-[56px_1fr_1fr] border-b border-[#0B3B4A]/10 py-8 md:py-7 last:border-none", children: [
        /* @__PURE__ */ jsx("div", { className: "font-['Cormorant_Garamond',serif] text-[32px] md:text-[42px] text-[#0B3B4A]/10 font-bold leading-none mb-4 md:mb-0 md:pt-1", children: w.n }),
        /* @__PURE__ */ jsxs("div", { className: "md:pr-12 md:border-r border-[#0B3B4A]/10 mb-6 md:mb-0", children: [
          /* @__PURE__ */ jsx("div", { className: "font-['Cormorant_Garamond',serif] text-[19px] md:text-[20px] text-[#0B3B4A] font-medium mb-3 leading-[1.2]", children: w.t }),
          /* @__PURE__ */ jsx("p", { className: "text-[13px] md:text-[13.5px] text-[#5c5c5c] leading-[1.7] md:leading-[1.8]", children: w.b })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "md:pl-12", children: /* @__PURE__ */ jsx("p", { className: "text-[13px] md:text-[13.5px] text-[#5c5c5c] leading-[1.7] md:leading-[1.8]", children: w.d }) })
      ] }, i)) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-[#0B3B4A] py-16 md:py-14 px-6 md:px-[52px] flex flex-col md:flex-row items-start md:items-center justify-between gap-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "w-full md:w-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "font-['Cormorant_Garamond',serif] text-[clamp(28px,5vw,42px)] text-white font-normal leading-[1.2] mb-4", children: [
          "Have a matter in mind?",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("em", { className: "text-[#C4912A] italic", children: "Let's talk." })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[13px] md:text-[13.5px] text-white/55 leading-[1.7] max-w-[480px]", children: "No obligation. A short conversation is usually enough to understand whether FCC can help and how." })
      ] }),
      /* @__PURE__ */ jsx(Link, { to: "/contact", className: "w-full md:w-auto text-center bg-[#C4912A] hover:bg-[#a87822] text-white py-4 px-10 text-[11px] md:text-[12px] font-semibold tracking-[.1em] uppercase transition-colors", children: "Get in Touch" })
    ] })
  ] });
}
...
function App() {
  return /* @__PURE__ */ jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsx(Route, { path: "/book-a-meeting", element: /* @__PURE__ */ jsx(SathwikMeetingCalendar, {}) }),
    /* @__PURE__ */ jsx(Route, { path: "/blogs", element: /* @__PURE__ */ jsx(BlogArchivePage, {}) }),
    /* @__PURE__ */ jsx(Route, { path: "/blogs/:slug", element: /* @__PURE__ */ jsx(BlogSinglePage, {}) }),
...
const routes = [
  {
    path: "/",
    element: /* @__PURE__ */ jsx(React.StrictMode, { children: /* @__PURE__ */ jsx(HelmetProvider, { children: /* @__PURE__ */ jsx(App, {}) }) })
  }
];
