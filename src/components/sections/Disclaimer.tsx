...
export default function Disclaimer(): JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 bg-[#05161c]/95 z-[9999] flex items-center justify-center p-6">
      <div className="bg-white max-w-[560px] w-full p-6 md:p-12 border-t-[3px] border-[#0B3B4A]">
        <div className="font-['Cormorant_Garamond',serif] text-[18px] font-semibold text-[#0B3B4A] tracking-[.04em] mb-8 flex items-center gap-3">
          <img src={logoUrl} alt="FCC" className="h-[44px] w-auto" />
          <div>Founder's Counsel <span className="text-[#C4912A]">&amp; Co</span></div>
        </div>
        <h3 className="font-['Cormorant_Garamond',serif] text-[22px] text-[#0B3B4A] mb-4">Disclaimer</h3>
        <p className="text-[12.5px] leading-[1.9] text-[#5c5c5c] mb-4">
        ...
        <p className="text-[12.5px] leading-[1.9] text-[#5c5c5c] mb-5">
        ...
        <div className="flex gap-3 items-start mb-7">
          ...
          />
          <label htmlFor="dc" className="text-[12px] text-[#5c5c5c] leading-[1.7]">
