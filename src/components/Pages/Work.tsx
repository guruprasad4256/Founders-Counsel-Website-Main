...
export default function Work(): JSX.Element {
  return (
    <div className="pt-[72px] font-['Inter',sans-serif]">
      {/* Hero Section */}
      <div className="bg-[#052028] pt-12 pb-11 px-6 md:px-[52px]">
        <p className="text-[11px] tracking-[.16em] md:tracking-[.22em] uppercase text-[#C4912A] font-semibold mb-5">
          Selected Matters
        </p>
        <h1 className="font-['Cormorant_Garamond',serif] text-[clamp(38px,5.5vw,70px)] text-white font-normal leading-none tracking-[-.01em]">
          Real matters.<br />
          <em className="text-[#C4912A] italic">Real outcomes.</em>
        </h1>
        <p className="text-[14px] text-white/60 mt-5 max-w-[500px] leading-[1.8]">
      ...
      <div className="bg-[#0B3B4A] py-14 px-6 md:px-[52px] flex items-center justify-between gap-10 flex-wrap">
        <div>
          <div className="font-['Cormorant_Garamond',serif] text-[clamp(26px,3vw,42px)] text-white font-normal leading-[1.25] mb-4">
            Have a matter that needs <em className="text-[#C4912A] italic">careful handling?</em>
          </div>
